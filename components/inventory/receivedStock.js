...
renderPopover=(value,row)=>{
    return `<div style="position:relative" id='${row.billNumber}' onclick="showPopover('${row.billNumber}','${row.purchaseOrderID}',this)" class ="customViewButton"> <img src="../../assets/img/ic-more-vertical-gray.png" /> </div>`
}
...
function showPopover(billNumber,poID,el){
    ...
    if(positionObj.top > 800){
        $("#"+billNumber).append(`<div class='popoverDiv popoverPosition'>
        <span class="popoverSpan"  onclick="getReceivedStockProducts('${billNumber}','')"><img class="popoverIcon" src="../../assets/img/download_grey.png" /> <small>Download</small></span>
        <span class="popoverSpan"  onclick="getReceivedStockProducts('${billNumber}','print')"><img class="popoverIcon" src="../../assets/img/print_grey.png" /> <small>Print</small></span>
        <a class="popoverSpan" href="receivedStockDetails.html?billNumber=${billNumber}=${poID}"><img class="popoverIcon" src="../../assets/img/view_icon.png" /> <small>View</small></a></div>`);
    }
    else {
        
        $("#"+billNumber).append(`<div class="popoverDiv">
        <span class="popoverSpan"  onclick="getReceivedStockProducts('${billNumber}','')"><img class="popoverIcon" src="../../assets/img/download_grey.png" /> <small>Download</small></span>
        <span class="popoverSpan"  onclick="getReceivedStockProducts('${billNumber}','print')"><img class="popoverIcon" src="../../assets/img/print_grey.png" /> <small>Print</small></span>
        <a class="popoverSpan" href="receivedStockDetails.html?billNumber=${billNumber}=${poID}"><img class="popoverIcon" src="../../assets/img/view_icon.png" /> <small>View</small></a></div>`);
    }	  
